...
class Group extends Resource
{
     ...
     * @return Group
     */
    public function setExternalSyncIdentifier(string $external_sync_identifier): Group
    {
     ...
     * @return Group
     */
    public function setInvitabilityLevel(string $invitability_level): Group
    {
     ...
     * @return Group
     */
    public function setMemberViewabilityLevel(string $member_viewability_level): Group
    {
     ...
     * @return Group
     */
    public function setProvenance(string $provenance): Group
    {
